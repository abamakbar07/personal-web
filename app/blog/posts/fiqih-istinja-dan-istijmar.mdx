...
| Aspek         | Istinja                     | Istijmar                     |
|--------------|---------------------------|-----------------------------|
| Cara        | Menggunakan air              | Menggunakan benda kering seperti batu atau tisu |
| Hukum       | Sunnah muakkadah (ditekankan) | Boleh, tetapi sebaiknya disempurnakan dengan air |
| Keutamaan   | Lebih menyucikan             | Cukup jika najis benar-benar hilang |
