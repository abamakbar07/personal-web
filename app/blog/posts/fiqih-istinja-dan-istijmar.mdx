...
| **Aspek**       | **Istinja (Pakai Air)**   | **Istijmar (Pakai Benda Kering)** |
|-----------------|--------------------------|----------------------------------|
| **Cara**        | Menggunakan air untuk membersihkan najis | Menggunakan benda kering seperti batu atau tisu |
| **Hukum**       | Sunnah muakkadah (dianjurkan kuat) | Boleh, tetapi lebih utama jika disempurnakan dengan air |
| **Kebersihan**  | Lebih menyucikan dan memastikan najis hilang | Bisa cukup jika najis benar-benar hilang, tapi tidak sebersih air |
| **Keutamaan**   | Lebih utama dan lebih dianjurkan dalam Islam | Alternatif jika air tidak tersedia atau sulit digunakan |
